            ...
            <nav class="bg-white border-b border-gray-100">
                        ...
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('dashboard.show')">
                                    <JetApplicationMark class="block h-40 w-min" />
                                </Link>
                            </div>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <JetNavLink v-if="$page.props.user.role === 'user'" :href="route('dancing.show')" :active="route().current('dancing.show')">
                                    Tanzpartner
                                </JetNavLink>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <JetNavLink :href="route('events.show')" :active="route().current('events')">
                            Events
                        </JetNavLink>
                    </div>
